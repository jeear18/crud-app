          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" @submit.prevent="login"> 
                  ...
                  <div>
                      ...
                      <div v-if="form.errors.email" class="text-sm text-red-500 dark:text-red-400">{{ form.errors.password }}</div>
                    </div>
                  ...
                  <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                      Don’t have an account yet? <Link :href="route('create-acc')" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Sign up</Link>
                  </p>
